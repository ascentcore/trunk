...
export default function flex(config) {
    ...
    generatePath(flexHeavyWeightLeft, weightPath, "gray", "gray", 1, 235, 130, 4, 7, 0);
    generatePath(flexHeavyWeightRight, weightPath, "gray", "gray", 1, -50, 130, 4, 7, 0);
    generatePath(flexLightWeightLeft, weightPath, "gray", "gray", 1, 260, 145, 3, 5, 0);
    generatePath(flexLightWeightRight, weightPath, "gray", "gray", 1, -70, 145, 3, 5, 0);
