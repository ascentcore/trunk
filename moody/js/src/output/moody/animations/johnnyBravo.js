...
export default function johnnyBravo(config) {
  ...
  let jBTopPath =
    'M 250 550 L 500 550 Q 650 250 550 250 Q 500 150 350 50 Q 250 50 150 150 Q 150 300 250 550';
  let jBGlassesPath =
    'M 150 250 C 50 450 400 450 350 250 L 450 250 C 400 450 750 450 650 250 L 150 250';
